...
function Call() {
  ...
  const {
    localAudioTrack, localVideoTrack, leave, join, joinState, remoteUsers, volumeIndicator
  } = useAgora(client);
    ...
    <div className='call'>
      ...
      <div className='player-container'>
        <div className='local-player-wrapper'>
          ...
          <MediaPlayer videoTrack={localVideoTrack} audioTrack={localAudioTrack} uid={client.uid} volumeIndicator={volumeIndicator} ></MediaPlayer>
        </div>
